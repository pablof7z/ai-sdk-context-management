...
function normalizeKeepLastMessages(value: number | null | undefined): number | undefined {
...
function normalizeScratchpadState(
      ...
      scratchpad: tool<ScratchpadToolInput, ScratchpadToolResult>({
        ...
        execute: async (input, options) => {
          ...
          const currentState = normalizeScratchpadState(
            await this.scratchpadStore.get(key),
            requestContext.agentLabel
          );
          const nextState: ScratchpadState = {
            ...currentState,
