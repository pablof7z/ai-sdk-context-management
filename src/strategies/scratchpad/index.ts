...
function buildReminderBlock(options: {
  ...
  if (forced) {
    lines.push(
      ...
      "2. Record user requirements, constraints, and completion state so preserved turns do not look unresolved",
      "3. Set preserveTurns to compact older turns (e.g. 2-4)",
      "4. Add completed tool call IDs to omitToolCallIds",
