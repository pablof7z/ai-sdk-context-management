...
import type { PinnedStore, PinnedStoreKey } from "../../../types.js";
...
export function createPinToolResultTool(options: {
  ...
  return tool<{ pin?: string[]; unpin?: string[] }, { ok: true; pinned: string[] }>({
    ...
    execute: async (input: { pin?: string[]; unpin?: string[] }, executeOptions) => {
