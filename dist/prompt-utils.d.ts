import type { JSONObject, LanguageModelV3CallOptions, LanguageModelV3Message, LanguageModelV3Prompt } from "@ai-sdk/provider";
...
export declare function buildContextManagementSystemMessage(content: string, metadata?: JSONObject): LanguageModelV3Message;
export declare function buildContextManagementUserOverlayMessage(content: string, metadata?: JSONObject): Extract<LanguageModelV3Message, {
    role: "user";
}>;
