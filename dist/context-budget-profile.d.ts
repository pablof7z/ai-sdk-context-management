...
export declare function estimateBudgetProfileTokens(profile: NormalizedContextBudgetProfile, prompt: LanguageModelV3CallOptions["prompt"], tools: LanguageModelV3CallOptions["tools"]): number;
